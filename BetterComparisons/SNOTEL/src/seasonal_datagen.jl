...
snotel_comp_args = pairs((;load_data_func = load_snotel,
...
function seasonal_datagen(; eratype, basin_to_stations = basin_to_snotel,
    stat_name, station_compare_args = snotel_comp_args, 
    load_era_func, times_to_select)
