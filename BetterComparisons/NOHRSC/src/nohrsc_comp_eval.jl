...
include.(joinpath.("../../Snow_Course/src", ("snow_course_comp_func.jl", "land_vs_base_func.jl")))

savedir = "../vis/plain_nn"

nohrsc_compare_args = (;load_data_func = load_nohrsc_only,
...
mkpath(savedir)
snow_course_comp_lineplot(;era_load_func = load_nohrsc_era, savedir,
    ...
    diffsym = :fom_diff_mean, climodiffsym = :gamma_fom_mean,
    era_swe_name = :mean_era_swe_fom_mean, station_swe_name = :gamma_fom_mean,)