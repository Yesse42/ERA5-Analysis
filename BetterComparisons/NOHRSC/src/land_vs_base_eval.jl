...
basin_to_flines = jldopen(joinpath(ERA.NOHRSCDATA, "Land_basin_to_flines.jld2"))["basin_to_flines"]

nohrsc_args = pairs((;load_data_func = load_nohrsc_only,
...
mkpath(savedir)
datavec = land_vs_base_datagen(;load_era_func = load_nohrsc_era, base_stat_name = :fom_rmsd, climo_stat_name = :climo_fom_rmsd,
time_to_pick=true, basin_to_stations = basin_to_flines, station_compare_args = nohrsc_args)
...
error_bar_plot(datavec, savedir; style_kwargs, plotname= "NOHRSC_basin_summary.png", legend = :topright)